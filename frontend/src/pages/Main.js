      ...
      <FullPage controls controlsProps={{ className: "slide-navigation" }}>
        <FullSlide>        
          <div className="section-common section-area1">
            <img src="/static/img/main1.jpg" style={{width:'100%', height:'100%'}} alt="main image"/>
        ...
        <FullSlide>
          <div className="section-common section-area2" style={{backgroundImage:"url(/static/img/main3.jpg)"}}>
            <div className="main2-right">
              {/* <h1 id="main2Title">Create your Unique item</h1> */}
                <h1 className="word s">Create<br/>your<br/>Unique item</h1>
            </div>
          </div>
        </FullSlide>
        <FullSlide>
